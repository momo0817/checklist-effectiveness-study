...
def load_args():
    ...
    args.add_argument(
        ...
        default = "./data/dataset/InFoBench/expert_annotation/test/dataset.json"
    )
    args.add_argument(
        "--checklist_model",
        type = str,
    ...
    args.add_argument(
        ...
        type = str,
        help = "Path to the output file",
        default = "./analysis/data/classification/scoring/{subset}/generated_{checklist_model}/preprocessed_checklists.json"
    )
    args.add_argument(
        "--subset_eval_results_path",
        type = str,
        help = "Path to the output file",
        default = "./analysis/data/classification/scoring/{subset}/{policy}:{checklist_model}/{eval_model}/eval_results.json"
    )
    args.add_argument(
        "--subset_no_checklist_eval_results_path",
        type = str,
        help = "Path to the output file",
        default = "./analysis/data/classification/scoring/{subset}/{policy}:{checklist_model}/{eval_model}/no_checklist_eval_results.json"
    )
    args.add_argument(
        "--checklist_subset_stats_path",
        type = str,
        help = "Path to the output",
        default = "./analysis/data/stats/scoring/InFoBench/subset_classification/{checklist_model}/{eval_model}.jsonl"
    )
