...
BASELINE_EVAL_OUTPUT_PATH="./outputs/abs_evaluation/baseline/InFoBench/${SIMPLE_EVAL_MODEL_NAME}.jsonl"
...
CHECKLIST_EVAL_OUTPUT_PATH="./outputs/abs_evaluation/checklist/adjust_${FACTOR}_${CHECKLIST_TYPE}:${SIMPLE_CHECKLIST_MODEL_NAME}/InFoBench/${SIMPLE_EVAL_MODEL_NAME}.jsonl"
