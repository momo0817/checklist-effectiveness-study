...
REFINE_CHECKLIST_PATH="./outputs/checklist/refine_${CHECKLIST_TYPE}/LLMBar/${SIMPLE_CHECKLIST_MODEL_NAME}.jsonl"
...
CHECKLIST_EVAL_OUTPUT_PATH="./outputs/evaluation/checklist/refine_${CHECKLIST_TYPE}:${SIMPLE_CHECKLIST_MODEL_NAME}/LLMBar/${SIMPLE_EVAL_MODEL_NAME}.jsonl"
