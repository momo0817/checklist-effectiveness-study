...
BASELINE_EVAL_OUTPUT_PATH="./outputs/abs_evaluation/baseline/${SIMPLE_DATASET_SUB_DIR}/${SIMPLE_EVAL_MODEL_NAME}.jsonl"
...
python3 src/experiment/abs_evaluate_response.py \
    ...
    --base-prompt-path ./data/prompt/abs_evaluate_response/baseline.txt \
...
CHECKLIST_PATH="./outputs/checklist/${CHECKLIST_TYPE}/${SIMPLE_DATASET_SUB_DIR}/${SIMPLE_CHECKLIST_MODEL_NAME}.jsonl"
...
REFINE_CHECKLIST_PROMPT_PATH="data/prompt/refine_checklist/refine_${CHECKLIST_TYPE}.txt"
REFINE_CHECKLIST_PATH="./outputs/checklist/refine_${CHECKLIST_TYPE}/${SIMPLE_DATASET_SUB_DIR}/${SIMPLE_CHECKLIST_MODEL_NAME}.jsonl"
...
CHECKLIST_EVAL_OUTPUT_PATH="./outputs/abs_evaluation/checklist/refine_${CHECKLIST_TYPE}:${SIMPLE_CHECKLIST_MODEL_NAME}/${SIMPLE_DATASET_SUB_DIR}/${SIMPLE_EVAL_MODEL_NAME}.jsonl"
